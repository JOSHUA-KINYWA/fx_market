    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-12">
        <div className="max-w-md w-full">
          <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl p-8 space-y-6 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-full mx-auto mb-4">
            ...
            <p className="text-slate-300">
              Your account has been created successfully. You can now log in to start tracking your trades.
            </p>
            <div className="space-y-3 pt-4">
              <Link href="/login" className="block">
                <Button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-2.5 rounded-lg transition">
                  Go to Login
                </Button>
              </Link>
              <button
                ...
                className="w-full text-slate-400 hover:text-slate-300 font-medium transition"
              >
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-2">Join thousands of traders improving their discipline</p>
        </div>
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl p-8 space-y-6">
          ...
          <form className="space-y-5" onSubmit={handleRegister}>
                ...
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {passwordStrength.label && (
                      <span className={`text-xs font-semibold ${passwordStrength.color === 'bg-red-500' ? 'text-red-400' : passwordStrength.color === 'bg-yellow-500' ? 'text-yellow-400' : passwordStrength.color === 'bg-green-500' ? 'text-green-400' : 'text-blue-400'}`}>
                        {passwordStrength.label}
                      </span>
                    )}
                  </div>
            ...
            <label className="flex items-start gap-2">
              <input type="checkbox" className="rounded bg-slate-700 border-slate-600 mt-1" required />
