...
import { AnalyticsDashboardWithFilters } from "@/components/analytics/analytics-dashboard-with-filters";
import { DisciplineEvaluation } from "@/components/analytics/discipline-evaluation";
      ...
      <div className="px-4 py-6 sm:px-0">
        <div className="mb-6">
          ...
          <p className="mt-2 text-slate-600">
            Analyze your trading performance, discipline, and risk management
          </p>
        </div>
